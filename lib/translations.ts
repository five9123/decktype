...
export const TRANSLATIONS: Record<Lang, Translations> = {
  ...
  ko: {
    ...
    landingSubtext: '가사, 자막 파일, URL 어디서든 붙여넣기하세요. AI가 어휘 카드를 만들어 드립니다 — 타이핑, word games, 빈칸채우기로 연습하세요.',
    startForFree: '무료로 시작',
    ...
    step02Desc: '클래식 타이핑, word games(떨어지는 단어 받아치기), 빈칸채우기 중 선택하세요. 모든 모드에서 WPM과 정확도를 추적합니다.',
    ...
    feature3Desc: '클래식 타이핑, word games(하늘에서 단어가 내려옵니다 — 타이핑으로 격추), 빈칸채우기. 다양한 모드로 지루하지 않게 학습하세요.',
    ...
    whatIsTitle: 'typee란?',
    whatIsDesc: 'typee는 AI 기반 언어 학습 도구입니다. 좋아하는 노래 가사, 영화 자막, 또는 어떤 URL이든 붙여넣기하면 AI가 어휘를 추출하고 연습 카드를 생성합니다. 그런 다음 클래식 타이핑, word games(하늘에서 단어가 내려옵니다 — 타이핑으로 격추), 또는 빈칸채우기로 연습하세요.',
    whatIsDetail1: 'Anki 덱, 노래 가사, 영화 자막(.srt), URL 어디서든 가져올 수 있습니다. AI가 어휘를 자동 추출하고 카드를 생성합니다 — 수동 작업 불필요.',
    whatIsDetail2: '클래식 타이핑은 근육 기억을 만들고, word games는 스피드를 키우고, 빈칸채우기는 문맥 이해력을 높입니다. 모든 모드가 같은 덱을 사용합니다.',
    ...
    homeFaq1A: 'typee는 AI 기반 언어 학습 앱입니다. 가사, 자막(.srt), URL을 붙여넣으면 AI(GPT-4o-mini)가 어휘 카드를 자동 생성합니다. 클래식 타이핑, word games, 빈칸채우기 3가지 게임으로 연습할 수 있습니다. 모든 세션에서 WPM, 정확도, 마스터리를 추적합니다.',
    ...
    homeFaq5A: 'typee는 3가지 연습 모드를 제공합니다: 클래식 타이핑(앞면 보고 답 입력), word games(위에서 단어가 떨어지면 타이핑으로 격추), 빈칸채우기(문장의 빈칸에 단어 입력). 모든 모드에서 WPM과 정확도를 추적합니다.',
  ...
  ja: {
    ...
    landingHero2: '言語を学ぼう。',
    landingSubtext: '歌詞を貼り付け、字幕ファイルをドロップ、URLを共有するだけ。AIが語彙カードを作成 — タイピング、word games、穴埋め問題で練習。',
    startForFree: '無料で始める',
    ...
    step02Desc: 'クラシックタイピング、word games（落ちてくる単語をタイピングで撃破）、穴埋め問題から選択。全モードでWPMと精度を追跡。',
    step03Title: '上達を確認',
    ...
    feature3Desc: 'クラシックタイピング、word games（単語が空から降ってくる — タイピングで撃破）、穴埋め問題。飽きないモードで学習継続。',
    ...
    whatIsTitle: 'typeeとは？',
    whatIsDesc: 'typeeはAI搭載の言語学習ツールです。好きな曲の歌詞、映画の字幕、またはどんなURLでも貼り付けると、AIが語彙を抽出して練習カードを作成します。クラシックタイピング、word games（単語が空から降ってきます — タイピングで撃破）、または穴埋め問題でゲーム感覚で練習しましょう。',
    whatIsDetail1: 'Ankiデッキ、歌詞、映画字幕(.srt)、URLからコンテンツを取り込めます。AIが自動で語彙を抽出しカードを生成 — 手作業不要。',
    whatIsDetail2: 'クラシックタイピングは筋肉記憶を構築。word gamesはスピードを鍛える。穴埋めは文脈理解を深める。すべてのモードが同じデッキを使用。',
    whatIsDetail3: '6言語インターフェースと10以上のテーマ対応。無料プランは1デッキ最大100枚。Proプランは月額$5で無制限デッキ。',
    homeFaqTitle: 'よくある質問',
    homeFaq1Q: 'typeeとは何ですか？どのように動作しますか？',
    homeFaq1A: 'typeeはAI搭載の言語学習アプリです。歌詞、字幕(.srt)、URLを貼り付けるとAI（GPT-4o-mini）が語彙カードを自動生成します。クラシックタイピング、word games、穴埋め問題の3つのゲームモードで練習できます。WPM、精度、習熟度を毎回追跡します。',
    ...
    homeFaq5A: 'typeeは3つの練習モードを提供します：クラシックタイピング（表を見て答えを入力）、word games（上から単語が降ってくる — タイピングで撃破）、穴埋め問題（文章の空欄に単語を入力）。全モードでWPMと精度を追跡します。',
  ...
  es: {
    ...
    landingSubtext: 'Pega letras, sube archivos de subtítulos o comparte una URL. La IA crea tarjetas de vocabulario — practica con escritura, word games o completa los espacios.',
    ...
    step02Desc: 'Escritura clásica, word games (atrapa palabras que caen) o completa los espacios. Todos los modos registran tu WPM y precisión.',
    ...
    feature3Desc: 'Escritura clásica, word games (palabras caen del cielo — escríbelas para destruirlas) y completa los espacios. Diferentes modos para no aburrirse.',
    ...
    whatIsDesc: 'typee es una herramienta de aprendizaje de idiomas con IA. Pega letras de canciones, sube subtítulos o comparte una URL — la IA extrae vocabulario y crea tarjetas de práctica. Luego elige tu juego: escritura clásica, word games (palabras que caen del cielo) o completar espacios en blanco.',
    ...
    whatIsDetail2: 'La escritura clásica construye memoria muscular. word games entrena velocidad. Completar espacios mejora la comprensión. Todos los modos usan el mismo mazo.',
    ...
    homeFaq1A: 'typee es una app de aprendizaje de idiomas con IA. Pega letras, subtítulos (.srt) o cualquier URL — la IA (GPT-4o-mini) crea tarjetas de vocabulario automáticamente. Practica con tres modos: escritura clásica, word games o completar espacios. Cada sesión registra tu WPM, precisión y dominio.',
    ...
    homeFaq5A: 'typee ofrece tres modos: Escritura clásica (ve el frente, escribe la respuesta), word games (las palabras caen desde arriba — escríbelas antes de que lleguen abajo) y Completar espacios (completa la palabra que falta). Todos registran WPM y precisión.',
  ...
  zh: {
    ...
    landingHero2: '学习语言。',
    landingSubtext: '粘贴歌词、上传字幕文件或分享任意URL。AI自动生成词汇卡片 — 用打字练习、word games或填空题来学习。',
    startForFree: '免费开始',
    ...
    step02Title: '按你的方式练习',
    step02Desc: '选择你的游戏：经典打字、word games（接住下落的单词）或填空题。所有模式均追踪WPM和准确率。',
    step03Title: '见证自己的进步',
    ...
    feature3Desc: '经典打字、word games（单词从天而降——输入来消灭）和填空题。多种模式让学习不枯燥。',
    ...
    whatIsDesc: 'typee是AI驱动的语言学习工具。粘贴歌词、上传字幕或分享URL——AI提取词汇并创建练习卡片。然后选择你的游戏：经典打字练习、word games（单词从天而降）或填空句子练习。',
    whatIsDetail1: '导入Anki牌组、粘贴歌词或电影字幕(.srt)、或分享任意URL。AI自动提取词汇并生成卡片——无需手动操作。',
    whatIsDetail2: '经典打字建立肌肉记忆。word games训练速度。填空题提升阅读理解。所有模式使用同一牌组。',
    whatIsDetail3: '支持6种界面语言和10多个主题。免费计划：1个牌组，最多100张卡片。Pro计划每月$5，无限牌组。',
    homeFaqTitle: '常见问题',
    homeFaq1Q: 'typee是什么？如何使用？',
    homeFaq1A: 'typee是AI驱动的语言学习应用。粘贴歌词、字幕(.srt)或任意URL——AI（GPT-4o-mini）自动创建词汇卡片。用三种游戏模式练习：经典打字、word games或填空题。每次练习追踪WPM、准确率和掌握程度。',
    homeFaq2Q: 'typee免费吗？',
    ...
    homeFaq5Q: '有哪些游戏模式？',
    homeFaq5A: 'typee提供三种练习模式：经典打字（看正面、输入答案）、word games（单词从顶部下落——输入来消灭）和填空题（完成句子中缺失的单词）。所有模式追踪WPM和准确率。',
  ...
  fr: {
    ...
    landingSubtext: 'Collez des paroles, déposez un fichier de sous-titres ou partagez une URL. L\'IA crée des cartes de vocabulaire — puis pratiquez avec la frappe, word games ou des exercices à trous.',
    ...
    step02Desc: 'Choisissez votre jeu : frappe classique, word games (attrapez les mots qui tombent) ou exercices à trous. Chaque mode suit votre WPM et précision.',
    ...
    feature3Desc: 'Frappe classique, word games (les mots tombent du ciel — tapez pour les détruire) et exercices à trous. Des modes variés pour rendre l\'étude engageante.',
    ...
    whatIsDesc: "typee est un outil d'apprentissage des langues propulsé par l'IA. Collez des paroles, déposez des sous-titres ou partagez une URL — l'IA extrait le vocabulaire et crée des cartes. Choisissez ensuite votre jeu : frappe classique, word games (les mots tombent du ciel) ou exercices à trous. Vous construisez une vraie mémoire par le rappel actif, pas la révision passive.",
    ...
    whatIsDetail2: "La frappe classique développe la mémoire musculaire. word games est un mode de mots en chute rapide. Les exercices à trous testent la compréhension en lecture. Tous les modes utilisent le même deck.",
    ...
    homeFaq5A: "typee propose trois modes : Frappe classique (voyez le recto, tapez la réponse), word games (les mots tombent du haut — tapez-les avant qu'ils atteignent le bas) et Exercices à trous (complétez les phrases avec le mot manquant). Tous les modes suivent WPM et précision.",
