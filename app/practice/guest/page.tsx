...
function GuestPracticePageInner() {
  ...
  useEffect(() => {
    try {
      ...
      const parsed: GuestDeck = JSON.parse(raw);
    ...
    <>
      ...
      >
        ...
        <div className="px-4 pb-4 w-full mx-auto" style={{ maxWidth: '700px' }}>
          ...
          <VirtualKeyboard target={target} input={input} pronunciation={currentCard?.pronunciation} deckLang={deck?.sourceLang} />
        </div>
      </main>
    </>
  );
