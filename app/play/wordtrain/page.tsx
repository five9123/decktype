...
const WordTrainGame = dynamic(
  () =>
    import('@/components/WordTrainGame').then((m) => ({
      default: m.WordTrainGame,
    })),
  { ssr: false },
);
...
export default function SharedWordTrainPage() {
  const { t } = useLanguage();
    ...
    >
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-5xl mt-4 mb-2">🚂</p>
          <h1
          ...
          <p className="text-sm" style={{ color: 'var(--muted)' }}>
            {cards.length} {t.cards} &middot; {t.wordTrain}
          </p>
        </div>
